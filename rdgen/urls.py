...
urlpatterns = [
    url(r"^builds/$", views.builds_list),
    url(r"^builds/(?P<uuid>[a-f0-9-]+)/$", views.build_status),
    ...
    url(r'^api/configs/$', views.list_saved_configs),
    url(r'^api/configs/save$', views.save_config),
    url(r'^api/configs/load$', views.load_config),
    url(r'^api/configs/delete$', views.delete_config),
]
